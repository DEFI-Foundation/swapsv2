...
contract WPAXGPool is MetalSwapPoolAbstract {
    ...
    constructor(
        ...
        ERC721('MetalSwap NFT xWPAXG Liquidity Token', 'NFT xWPAXG')
    {}
        ...
        returns (uint256 liquidityToWithdraw)
    {
        ...
        require(
            ...
            'Error: amount of WPAXG to withdraw is too small'
        );
        require(
        ...
        require(
            ...
            'Error: your penalties are higher than the WPAXG to withdraw, please wait longer'
        );
