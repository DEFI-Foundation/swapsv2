...
contract WPAXGUSDTSwap is MetalSwapAbstract {
        ...
        returns (uint256 swapID)
    {
        ...
        if (swapType == SwapType(0)) {
            //swapType==SwapType(0) is the swapType WPAXG->usd
            threshold =
                currentPrice +
            ...
            //the ELSE refers to the swapType USD->WPAXG
            threshold =
                currentPrice -
                (currentPrice * (coverX100 - safetyMarginX100)) /
                100;
        ...
        checkSCUnpaused
    {
        ...
        if ((swap.swapType == SwapType(0))) {
            ...
            //swapType==SwapType(1) is the swapType USD->WPAXG
